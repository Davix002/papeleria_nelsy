...
<html lang="es">
  <head>
    ...
    <meta name="author" content="papeleria nelsy">
    <title>Papeleria Nelsy</title>
    <!-- Favicon -->
    <link >
      ...
      <div class="container mb-5">
        ...
        <header class="d-flex flex-wrap py-3 mb-5 border-bottom">
          <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
            <div class="container">
              <a class="navbar-brand" href="#">Papeleria Nelsy</a>
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="/papeleria_nelsy">Home</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="\papeleria_nelsy\imagenes\imagen.php">Nosotros</a>
                  </li>
                  <!-- <li class="nav-item">
